package org.hzt.ant;/*
 * org.hzt.ant.AStar class - implements the A* Pathfinding Algorithm on a provided org.hzt.ant.Graph and with a provided org.hzt.ant.Heuristic.
 */

import java.util.ArrayList;// imports library necessary for using the ArrayList to hold org.hzt.ant.NodeRecord lists
...
public class AStar {
	...
	}// listContains(ArrayList<org.hzt.ant.NodeRecord>, int) method
	...
	}// findNode(ArrayList<org.hzt.ant.NodeRecord>, int) method
	...
	}// reverse(ArrayList<org.hzt.ant.Connection>)
