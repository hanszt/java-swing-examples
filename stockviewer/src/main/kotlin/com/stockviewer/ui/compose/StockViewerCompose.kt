...
object StockViewerCompose {
    ...
    fun main(args: Array<String>) {
        ...
        application {
            val dataFetchMode = if ("mock" in profiles) DataFetchMode.MOCK_DATA else DataFetchMode.API_DATA
            val apiKey = properties.getProperty("api-key") ?: error("No API key provided")
            MainWindow(
